...
console.log(getSubscriptionPrice('professional')); //возвращает число 20.
console.log(getSubscriptionPrice('organization')); //возвращает число 50.
console.log(getSubscriptionPrice('starter')); //возвращает число 0.
