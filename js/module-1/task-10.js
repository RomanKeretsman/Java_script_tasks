...
console.log((makeMessage('Радар', 6150))); //возвращает 'Вы выбрали Радар, цена за штуку 6150 кредитов'.
console.log((makeMessage('Сканер', 3500))); //возвращает 'Вы выбрали Сканер, цена за штуку 3500 кредитов'.
console.log((makeMessage('Реактор', 8000))); //возвращает 'Вы выбрали Реактор, цена за штуку 8000 кредитов'.
console.log((makeMessage('Двигатель', 4070))); //возвращает 'Вы выбрали Двигатель, цена за штуку 4070 кредитов'.
