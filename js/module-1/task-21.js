...
console.log(isNumberInRange(10, 30, 17)); //возвращает true.
console.log(isNumberInRange(10, 30, 5)); //возвращает false.
console.log(isNumberInRange(20, 50, 24)); //возвращает true.
console.log(isNumberInRange(20, 50, 76)); //возвращает false.
