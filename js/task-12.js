...
console.log(makeOrderMessage(4, 300, 100)); //возвращает 'Вы заказали дроидов на сумму 1300 кредитов. Доставка (100 кредитов) включена в сумму заказа.'.
console.log(makeOrderMessage(10, 70, 200)); //возвращает 'Вы заказали дроидов на сумму 900 кредитов. Доставка (200 кредитов) включена в сумму заказа.'.
